  ...
  >
    <div :style="'width: calc(100% - ' + dialogProps.labelWidth! / 2 + 'px)'">
      ...
      <el-form-item label="客户名称" prop="name">
        <el-input v-model="dialogProps.row!.name" placeholder="请填写客户名称" clearablemaxlength="50" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="客户手机号" prop="phone">
        <el-input v-model="dialogProps.row!.phone" placeholder="请填写客户手机号" clearablemaxlength="11" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="客户邮箱" prop="email">
        <el-input v-model="dialogProps.row!.email" placeholder="请填写客户邮箱" clearablemaxlength="100" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="客户地址" prop="address">
        <el-input v-model="dialogProps.row!.address" placeholder="请填写客户地址" clearablemaxlength="100" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="客户等级" prop="level">
        <el-select v-model="dialogProps.row!.level" filterableplaceholder="请选择客户等级" class="w-full">
      ...
      <el-form-item label="客户来源" prop="source">
         <el-select v-model="dialogProps.row!.source" filterableplaceholder="请选择客户来源" class="w-full">
      ...
      <el-form-item label="跟进状态" prop="followStatus">
        <el-select v-model="dialogProps.row!.followStatus" filterableplaceholder="请选择客户跟进状态" class="w-full">
      ...
      <el-form-item label="是否为关键决策人" prop="isKeyDecisionMaker">
        <el-select v-model="dialogProps.row!.isKeyDecisionMaker" filterableplaceholder="请选择客户是否为关键决策人" class="w-full">
      ...
      <el-form-item label="客户性别" prop="gender">
        <el-select v-model="dialogProps.row!.gender" filterableplaceholder="请选择客户性别" class="w-full">
...
import {CustomerLevelList,CustomerSourceList,FollowUpStatusList,
  GenderList,IsKeyDecisionMakerList} from  '@/configs/enum'
